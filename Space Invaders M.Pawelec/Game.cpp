...
Game::Game(RenderWindow* window)
{
	...
	this->textures[player].loadFromFile("Textures/ship4.png");
	this->textures.push_back(Texture());
	...
	this->textures.push_back(Texture());
	this->textures[mainGun01].loadFromFile("Textures/Guns/gun04.png");
	this->textures.push_back(Texture());
	this->textures[enemy01].loadFromFile("Textures/enemy4.png");
